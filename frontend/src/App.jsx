...
import { Download, Upload, Lock, Unlock, Zap, Activity, Shield, Hash, Search, FileText, XCircle, CheckCircle2, AlertTriangle, Eye, EyeOff, Save, Trash2, ShieldAlert } from 'lucide-react';
...
const Card = ({ children, className = "", title, icon: Icon, glowColor = "var(--green-glow)" }) => (
                  ...
                  <div className="animate-fade-in flex flex-col gap-6">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 lg:gap-8">
                      ...
                      <div className="lg:col-span-7 flex flex-col gap-6">
                        ...
                        <Card title="EXTRACTION_SEQ_INIT" icon={Eye} glowColor="var(--cyan-dim)" className="flex-1 !border-cyan-900/40">
